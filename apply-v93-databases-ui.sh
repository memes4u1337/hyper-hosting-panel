...
# ============================================================================
# HYPER-HOST v93 · powered by memes4u1337
#   1) Страница баз данных: раскладка, слипшиеся подписи, карточки
#   2) Боты PM2: реальная нагрузка на сервер вместо декоративных цифр
#   3) SSL: выпуск на www и любые поддомены одним сертификатом
#
# Запуск:  sudo ./apply-v93-databases-ui.sh
#          sudo ./apply-v93-databases-ui.sh www.pixel-pc.store admin@example.com
# ============================================================================
...
BACKUP="$BASE/backups/v93-ui-bots-ssl-$STAMP"
...
rollback() {
  local code=$?
  trap - ERR
  warn 'Ошибка установки v93. Возвращаю предыдущие файлы.'
...
trap - ERR
ok 'v93 установлен: вёрстка починена, боты показывают реальную нагрузку, SSL умеет www.'
