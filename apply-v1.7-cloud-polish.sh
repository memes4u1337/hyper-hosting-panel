...
PATCH_VERSION="v99-cloud-polish"
...
BACKUP_DIR="${BACKUP_BASE}/cloud-v99-${STAMP}"
...
[[ "$EUID" -eq 0 ]] || fail "Запусти от root: sudo ./apply-v1.7-cloud-polish.sh /root/hyper-hosting-panel"
...
# Version marker.
s,n=re.subn(r"function hh_app_version\(\): string \{ return '[^']+'; \}", "function hh_app_version(): string { return '1.9-v99-cloud'; }", s, count=1)
if n!=1:
