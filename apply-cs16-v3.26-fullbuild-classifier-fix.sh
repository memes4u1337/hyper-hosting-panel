...
# HYPER-HOST CS16 v3.26 — FULL BUILD CLASSIFIER FIX
#
...
BACKUP="/root/hyper-cs16-v3.26-backup-${STAMP}"
LOG="/root/hyper-cs16-v3.26-${STAMP}.log"
...
echo "============================================================"
echo " HYPER-HOST CS16 v3.26 — FULL BUILD CLASSIFIER FIX"
echo "============================================================"
echo "Server: $SID"
echo "Live:   $LIVE_CTL"
echo "Repo:   $REPO_CTL"
...
echo "[1/6] Patching live + repository controllers..."
...
echo "[4/6] Classifier regression test..."
python3 - <<'PY'
from pathlib import Path
import tempfile
...
echo "[6/6] Current server diagnostic only..."
...
echo
echo "============================================================"
echo " v3.26 INSTALLED SUCCESSFULLY"
echo "============================================================"
...
echo "After installing v3.26, RE-UPLOAD THE SAME img.zip once."
