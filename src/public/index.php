...
<div class="row g-4">
  <div class="col-xl-5"><div class="panel-card hero-mini"><div class="kicker"><i class="fa-solid fa-tower-broadcast me-2"></i>Внешний / внутренний доступ</div><h2>Поднимаем сайт наружу</h2><p class="muted">Ubuntu работает внутри сети: <code><?= e((string)app_config('server_ip')) ?></code>. Публично домен должен смотреть на роутер: <code><?= e($pub) ?></code>. Кнопка ниже откроет порты на сервере, поправит Nginx, ACME и нашу DNS-зону.</p>
