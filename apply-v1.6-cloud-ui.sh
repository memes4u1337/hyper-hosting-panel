...
PATCH_VERSION="v98-cloud-bootstrap-ui"
...
BACKUP_DIR="${BACKUP_BASE}/cloud-v98-${STAMP}"
...
[[ "$EUID" -eq 0 ]] || fail "Запусти от root: sudo ./apply-v1.6-cloud-ui.sh /root/hyper-hosting-panel"
...
# Version marker.
s,n=re.subn(r"function hh_app_version\(\): string \{ return '[^']+'; \}", "function hh_app_version(): string { return '1.9-v98-cloud'; }", s, count=1)
if n!=1:
