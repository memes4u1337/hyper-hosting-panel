# HYPER-HOST — установка, FTP, MySQL и DNS (v52 fixed IP)
...
- из интернета: `90.189.208.25:21`;
- passive-порты: `40000-40100`.

На роутере пробрось TCP `21` и TCP `40000-40100` на `192.168.0.179`.
...
Cron больше не определяет внешний IP через сторонние сайты. Он только восстанавливает
фиксированные значения, поэтому адрес прокси/VPN не сможет попасть в FTP, MySQL или DNS.
