...
PATCH_VERSION="v101-upload-html-preview"
...
BACKUP_DIR="${BACKUP_BASE}/cloud-v101-${STAMP}"
...
[[ "$EUID" -eq 0 ]] || fail "Запусти от root: sudo ./apply-v1.9-cloud-upload-preview.sh /root/hyper-hosting-panel"
...
# Version marker.
s,n=re.subn(r"function hh_app_version\(\): string \{ return '[^']+'; \}", "function hh_app_version(): string { return '1.9-v101-cloud'; }", s, count=1)
if n!=1:
